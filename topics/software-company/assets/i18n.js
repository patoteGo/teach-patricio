...
(() => {
  ...
  function applyLang(lang) {
    ...
    if (title) title.textContent = lang === "en" ? title.dataset.en : title.dataset.pt;
    ...
    subs.forEach((fn) => { try { fn(LANG); } catch {} });
  }

  function injectToggle() {
    if (document.querySelector(".langswitch")) return;
    const host = document.querySelector(".hero") || document.querySelector("article") || document.body;
