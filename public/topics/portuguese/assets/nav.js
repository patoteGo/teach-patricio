(() => {
	const pages = [
		{
			file: "0001-falsos-amigos-traicoeiros.html",
			n: "01",
			pt: "Falsos amigos traiçoeiros",
			en: "Treacherous false friends",
		},
		{
			file: "0002-sotaque-cinco-marcas.html",
			n: "02",
			pt: "Sotaque: as cinco marcas",
			en: "Accent: the five markers",
		},
	];
	...
	nav.setAttribute("aria-label", "Português");
	...
	reference.href = inReference
		? "falsos-amigos-espanhol.html"
		: "../reference/falsos-amigos-espanhol.html";
	if (here === "falsos-amigos-espanhol.html") reference.classList.add("active");
