	...
	const MANIFEST = {
		...
		"behavioral-interview": {
			...
			lessons: [
				...
				{
					f: "0005-architecture-grill.html",
					n: "05",
					t: { pt: "Architecture Grill", en: "Architecture Grill" },
				},
				{
					f: "0006-fanout-decoded.html",
					n: "06",
					t: { pt: "Fan-out, Decoded", en: "Fan-out, Decoded" },
				},
				{
					f: "0007-monitoring-lag-decoded.html",
					n: "07",
					t: { pt: "Monitoring & Lag", en: "Monitoring & Lag" },
				},
			],
			extra: [],
		},
